...
Una vez cargado el módulo, se crea el archivo `/proc/continfo_pr2_so1_202307705`.
...
Ejemplo de decisión cuando se elimina un contenedor:
...
Ejemplo cuando no se elimina por restricción:
...
El daemon genera el archivo `monitor_logs.jsonl`. Para revisarlo:
...
- Acción tomada (`deleted_container`, `deleted_reason`, `action_taken`)
